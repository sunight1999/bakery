...
}void UAbnormalitiesReportWidget::ExitButtonBinding()
{
}bool UAbnormalitiesReportWidget::Initialize()
{
    ...
    return true;
}//UTextBlock* UAbnormalitiesReportWidget::ChangeText(AAbnormalitiesReport* Report)
//{
//    UTextBlock* TextBlock = Cast<UTextBlock>(Report->OverlayWidgetInstance->GetWidgetFromName(TEXT("TestBlock")));
//    return TextBlock;
//}
//UButton* UAbnormalitiesReportWidget::ExitButtonBinding(AAbnormalitiesReport* Report)
//{
